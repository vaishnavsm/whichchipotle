...
const App: Component = () => {
  return (
    <div class="h-screen w-screen flex flex-col">
      <header class="h-5/6 bg-yellow-900 w-screen flex items-center justify-center flex-col gap-8">
        ...
        <div class="flex justify-center items-stretch self-stretch py-8">
          <div class="flex flex-col-reverse md:flex-row gap-6 justify-around items-center md:w-1/2">
            <div class="flex flex-1 flex-row gap-2 justify-center items-stretch">
              <input 
                class="outline outline-4 outline-blue-200 shadow-lg rounded-none rounded-l-xl text-xl w-full py-2 px-3 text-gray-700 leading-tight focus:outline-blue-500 focus:shadow-outline" 
                id="username" 
                type="text" 
                placeholder="Address" 
              />
              <button 
                class="flex gap-4 outline outline-4 outline-blue-500 hover:bg-blue-500 text-white font-bold text-xl py-4 px-6 rounded-r-xl"
            ...
            <button 
              class="flex gap-4 bg-blue-500 hover:bg-blue-700 text-white font-bold text-xl py-4 px-6 rounded-xl"
              onClick={() => alert("Soz, this doesn't work yet. It'll be there soon I promise!")}
            >
      ...
      <footer class="flex-1 bg-gray-800 w-screen flex items-center justify-center flex-col gap-8">
